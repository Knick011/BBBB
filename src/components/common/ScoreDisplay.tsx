...
// TODO: Import store when migrated
...
const ScoreDisplay: React.FC<ScoreDisplayProps> = ({ 
  ...
  // TODO: Uncomment these when the store is migrated
  // Get live score data including highest streak
  // const { dailyScore, highestStreak, animatingScore, animatingStreak } = useLiveScore();
  
  // Temporary placeholder values until store is available
  const dailyScore = score;
  const highestStreak = 3;
  const animatingScore = false;
  const animatingStreak = false;
